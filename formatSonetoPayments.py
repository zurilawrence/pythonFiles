...
def formatPaymentsExport(dfile):
    dfile.drop("textbox2","textbox48","textbox20","textbox50","textbox13","textbox18","textbox17","textbox8","textbox22","textbox5")

    #Add new header
    dfile.columns = ['Client','PostingDate','AmountPaid','PaymentNo','Invoice','ServiceDate')
