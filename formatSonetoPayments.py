...
def formatPayments(dfile):
    dfile.rename(columns={"textbox31":"Client","textbox57":"PostingDate","textbox6":"AmountPaid","textbox7":"PaymentNo","textbox32":"Invoice","textbox43":"ServiceDate"},inplace=True)
